...
const RightSidebar = () => {
  return (
    <section className="custom-scrollbar fixed top-0 right-0 z-40 flex h-screen w-87.5 flex-col gap-6 overflow-y-auto border-l light-border background-light900_dark200 p-6 pt-36 shadow-light-300 max-xl:hidden dark:shadow-none">
      <div>
